...
const Models = [
  ...
  { title: 'CYANARA', url: './CYANARA.glb', miEscala: .8, miPosicion: 0.1 },
]
  ...
  return (
    <>
      <Canvas camera={{ position: [0, .4, -0.6], near: .01, fov: 50 }}>
        <pointLight position={[100, 100, 0]} intensity={19555} decay={2} />
        <pointLight position={[-100, 100, 0]} intensity={19555} decay={2} />
        <pointLight position={[-100, 100, 100]} intensity={19111} decay={2} />
        <pointLight position={[100, -100, -100]} intensity={199111} decay={2} />
        <pointLight position={[100, -100, 100]} intensity={199111} decay={2} />
